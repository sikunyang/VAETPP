...
def load_dataset_multivariate(name: str, folder: Union[Path, str] = dataset_dir):
    ...
    ###
    path = os.getcwd()
    # with open('dataset_0427', 'rb') as handle:
    with open('dataset_4DimPoisson_0428', 'rb') as handle:
    ...
    sequences = [
        Sequence(
            inter_times=seq.get("inter_arrival_time"),# get_inter_times(seq),
            marks=seq.get("marks"),
