...
def load_dataset_mv(name: str, folder: Union[Path, str] = dataset_dir):
    ...
    # with open('dataset_MATHOF_dim7', 'rb') as handle:
    # with open('dataset_SOF_dim10', 'rb') as handle:
    # with open('dataset_ASKUBUN', 'rb') as handle:
    with open(name, 'rb') as handle:
    # with open('dataset_4DimPoisson_0605', 'rb') as handle:
    ...
    def get_inter_times_mv(seq: dict):
        """Get inter-event times from a sequence."""
